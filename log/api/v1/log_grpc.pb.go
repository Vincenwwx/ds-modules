...
type LogClient interface {
	...
	GetServers(ctx context.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServerResponse, error)
}
...
func (c *logClient) GetServers(ctx context.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServerResponse, error) {
...
type LogServer interface {
	...
	GetServers(context.Context, *GetServersRequest) (*GetServerResponse, error)
...
func (UnimplementedLogServer) GetServers(context.Context, *GetServersRequest) (*GetServerResponse, error) {
